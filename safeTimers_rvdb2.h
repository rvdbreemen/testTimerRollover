...
#define TIME_LEFT_16Bit(timerName)                  (timerName##_due-timer16Bit())

#define SINCE_16Bit(timerName)                      ((int16_t)(timer16Bit() - timerName##_due))
//#define DUE_16Bit(timerName)                        (( SINCE(timerName) >= 0) ? (timerName##_due+=timerName##_interval):0)
