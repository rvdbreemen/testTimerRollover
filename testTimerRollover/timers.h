...
//-------------------------------------------------------------------------------------
#define DECLARE_8BIT_TIMER(timerName, timerTime)    static uint8_t timerName##_interval = timerTime,      timerName##_last = myTimer;
...
#define DUE_8BIT(timerName)                          ((SINCE_8BIT(timerName) < timerName##_interval) ? 0 : (timerName##_last = (uint8_t)(timerName##_last + timerName##_interval)))   
